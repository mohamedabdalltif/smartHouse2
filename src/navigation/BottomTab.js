...
import {Trips, Home, Settings } from '../screens/appScreens';
...
const TabArr = [
  ...
  //   ArLabel: 'statistics',
  //   type: Ionicons,
  //   activeIcon: icons.sta,
  //   inActiveIcon: icons.full_sta,
...
function MyTabBar({state, descriptors, navigation}) {
  ...
  return (
    <View style={styles.tabBarContainer}>
      <Animated.View
        style={[styles.slidingTabContainer, {backgroundColor: COLORS.white,borderRadius: 10}]}>
        <Animated.View
          style={[
            styles.slidingTab,
            {
